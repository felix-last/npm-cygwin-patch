...
module.exports = function (opts) {
  opts = opts || {}
  var type = opts.type && opts.type.toLowerCase()
  if (type === 'json') {
    return jsonOutputStream()
  } else if (type === 'tab-separated') {
...
function textOutputStream (args, opts) {
  var line = 0
  return ms.through.obj(function (pkg, enc, cb) {
    cb(null, prettify(pkg, ++line, args, opts))
  })
}

function prettify (data, num, args, opts) {
  opts = opts || {}
